...
<body>
	...
	<div class="search" >
		<p class="searcht" align="center">Search</p>
		<form action="<?php echo base_url('search/dosearch') ?>" method="get" >
			<input class="un" type="text" name="search" placeholder="Search for?" >
			<input class="submit" align="center" type="submit" value="Search" >
		</form>
	</div>
</body>
</html>